...
def init_driver():
    ...
    # ================================== Driver Settings ================================= #
    response = stepper_controller.write(Register.STOP_ON_STALL, 1)  # don't stop motor on stall
    print(response)
    ...
    print(response)
    response = stepper_controller.write(Register.OPERATION_MODE, OpMode.POSITION)  # velocity mode
    print(response)
...
if __name__ == "__main__":
    ...
    print(response)
    response = stepper_controller.read(Register.HOMING_METHOD)
    print(response)
    response = stepper_controller.read(Register.REQUEST_HOMING)
    print(response)

    # =============================== Run stepper at n rpm =============================== #
    rpm = 200  # 10 - 2400

    stepper_controller.write(Register.TARGET_POSITION, 800)  # dummy value
